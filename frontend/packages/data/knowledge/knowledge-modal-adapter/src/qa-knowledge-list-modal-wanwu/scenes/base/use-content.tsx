...
import {
  useQAKnowledgeListModalContent as useQAKnowledgeListModalContentBase,
  type QADataSetModalContentProps,
  QAKnowledgeListModalContent as QAKnowledgeListModalContentBase,
} from '@coze-data/knowledge-modal-base';

import { useCreateKnowledgeModalV2 } from '../../../create-knowledge-modal-v2/scenes/base';
export const useQAKnowledgeListModalContent = (
  props: QADataSetModalContentProps,
) => {
  ...
  return useQAKnowledgeListModalContentBase({
    ...props,
    createKnowledgeModal,
  });
};

export const QAKnowledgeListModalContent = (props: QADataSetModalContentProps) => {
  const { projectID, onClickAddKnowledge, beforeCreate } = props;
  // A modal for creating a knowledge base
  const createKnowledgeModal = useCreateKnowledgeModalV2({
    projectID,
  ...
  return (
    <QAKnowledgeListModalContentBase
      {...props}
