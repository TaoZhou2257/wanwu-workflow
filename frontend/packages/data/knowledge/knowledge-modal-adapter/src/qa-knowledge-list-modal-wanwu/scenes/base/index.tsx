...
import {
  useQAKnowledgeListModal as useQAKnowledgeListModalBase,
...
export const useQAKnowledgeListModal = (
  params: Omit<UseQAKnowledgeListModalParams, 'createKnowledgeModal'>,
) => {
  ...
  return useQAKnowledgeListModalBase({
    ...params,
