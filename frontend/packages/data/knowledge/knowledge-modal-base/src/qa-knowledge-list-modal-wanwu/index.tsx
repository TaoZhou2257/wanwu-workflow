...
export interface UseQAKnowledgeListModalParams {
  datasetList: Dataset[];
...
export interface UseQAKnowledgeListReturnValue {
  node: JSX.Element;
  open: () => void;
  close: () => void;
}

export const useQAKnowledgeListModal = ({
  datasetList,
  onDatasetListChange,
  onClickAddKnowledge,
  beforeCreate,
  ...
  hideCreate,
  createKnowledgeModal,
}: UseQAKnowledgeListModalParams): UseQAKnowledgeListReturnValue => {
  ...
  return {
    node: (
      <UICompositionModal
        ...
        header={I18n.t('workflow_qa_dataset_set_title')}
        visible={visible}
...
export { QAKnowledgeCard } from './knowledge-card';
export {
  QAKnowledgeListModalContent,
  useQAKnowledgeListModalContent,
  FilterKnowledgeType,
...
export { QAKnowledgeCardListVertical } from './knowledge-card-list';
