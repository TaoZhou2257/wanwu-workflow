...
import { QAKnowledgeCardListVertical } from './knowledge-card-list';

import s from './index.module.less';

export interface QADataSetModalContentProps {
  datasetList: Dataset[];
...
const useQAKnowledgeListModalContent = ({
  datasetList,
  onDatasetListChange,
  onClickAddKnowledge,
  beforeCreate,
...
const QAKnowledgeListModalContent: FC<QADataSetModalContentProps> = ({
  datasetList,
  onDatasetListChange,
  onClickAddKnowledge,
  beforeCreate,
  ...
  const { renderContent } = useQAKnowledgeListModalContent({
    datasetList,
    onDatasetListChange,
    onClickAddKnowledge,
    beforeCreate,
...
export { useQAKnowledgeListModalContent, QAKnowledgeListModalContent };
