...
import { OrderBy, WorkFlowListStatus, WorkflowMode } from '@coze-workflow/base/api';
import { I18n } from '@coze-arch/i18n';
import {
  IconCozClockFill,
  IconCozCheckMarkCircleFill,
} from '@coze-arch/coze-design/icons';
import {Typography, LoadingButton, Tag} from '@coze-arch/coze-design';
          ...
          <div className={styles.tag_container}>
            <div className={styles.tag_left}>
              <Tag size="mini" color="primary">
                {data.flow_mode === WorkflowMode.ChatFlow ? I18n.t('wf_chatflow_76') : I18n.t('Workflow')}
              </Tag>
            </div>
