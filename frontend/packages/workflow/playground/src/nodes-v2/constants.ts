...
import { LLM_WANWU_NODE_REGISTRY } from '@/nodes-v2/llm-wanwu';
import {
  CODE_NODE_REGISTRY,
  ...
  DATASET_WANWU_NODE_REGISTRY,
  QA_DATASET_WANWU_NODE_REGISTRY,
  MCP_WANWU_NODE_REGISTRY,
  FILE_PARSE_WANWU_NODE_REGISTRY,
  FILE_GENERATE_WANWU_NODE_REGISTRY,
  MULTI_FILE_PARSE_WANWU_NODE_REGISTRY,
  JSON_PARSER_WANWU_NODE_REGISTRY,
  GUI_AGENT_WANWU_NODE_REGISTRY,
  AGENT_WANWU_NODE_REGISTRY,
  SKILL_WANWU_NODE_REGISTRY,
