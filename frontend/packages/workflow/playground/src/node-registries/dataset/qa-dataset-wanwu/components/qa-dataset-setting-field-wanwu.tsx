...
import { DataSetSetting as BaseDatasetSetting } from '@/form-extensions/components/dataset-setting/qa-index-wanwu';
import { useField, useWatch, withField } from '@/form';

const QADatasetSetting = () => {
...
export const QADatasetSettingFieldWanwu = withField(QADatasetSetting);
