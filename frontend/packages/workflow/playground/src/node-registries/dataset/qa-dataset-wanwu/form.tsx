...
import { QADatasetSelectFieldWanwu, QADatasetSettingFieldWanwu } from './components';
...
const Render = () => (
  <NodeConfigForm>
    ...
    />
    <Section
      title={I18n.t('workflow_detail_qa_knowledge_knowledge', {}, '问答库')}
      tooltip={I18n.t(
        'workflow_detail_qa_knowledge_introduction',
        {},
        '选择问答库',
      )}
    >
      <div className="w-full mb-[16px]">
        <QADatasetSelectFieldWanwu name="inputs.datasetParameters.datasetParam" />
      </div>
      <QADatasetSettingFieldWanwu name="inputs.datasetParameters.datasetSetting" />
    </Section>
    <OutputsField
