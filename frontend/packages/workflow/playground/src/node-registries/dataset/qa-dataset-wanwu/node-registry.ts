...
export const QA_DATASET_WANWU_NODE_REGISTRY: WorkflowNodeRegistry<NodeTestMeta> = {
  type: StandardNodeType.QADatasetWanwu,
  meta: {
    nodeDTOType: StandardNodeType.QADatasetWanwu,
    style: {
      width: 484,
    },
