...
import { useQAKnowledgeListModal } from '@coze-data/knowledge-modal-adapter';
...
export const DatasetSelect = ({
  ...
  const { node, open, close } = useQAKnowledgeListModal({
  ...
  return (
    <div className="relative">
      ...
      <LibrarySelect
        ...
        emptyText={I18n.t('workflow_qa_knowledge_node_empty')}
