...
const conditionList = {
  [TIME]: [
    ...
    {key: 'empty', value: I18n.t('datasets_metadata_null')},
    {key: 'not empty', value: I18n.t('datasets_metadata_notNull')},
  ],
  [STRING]: [
    {key: 'is', value: I18n.t('datasets_metadata_true')},
    ...
    {key: 'start with', value: I18n.t('datasets_metadata_begin')},
    {key: 'end with', value: I18n.t('datasets_metadata_end')},
    {key: 'empty', value: I18n.t('datasets_metadata_null')},
    {key: 'not empty', value: I18n.t('datasets_metadata_notNull')},
  ],
  [NUMBER]: [
